IF(STM32_FAMILY STREQUAL "F4")
	IF(STM_BOARD STREQUAL "STM32F429I-Discovery")
		...
		SET(BSP_SRC stm32f429i_discovery)
	ENDIF()
...
ELSEIF(STM32_FAMILY STREQUAL "F2")
	IF(STM_BOARD STREQUAL "STM32F2xx_Nucleo_144")
		SET(BSP_COMPONENTS "")
		SET(BSP_PREFIX "")
		SET(BSP_HEADERS stm32f2xx_nucleo_144.h)
		SET(BSP_SRC stm32f2xx_nucleo_144)
	ENDIF()
	SET(COMMON_COMPONENTS
		cs43l22
		ili9320
...
ELSEIF(STM32_FAMILY STREQUAL "F0")
	IF(STM_BOARD STREQUAL "STM32F0308-Discovery")
		...
		SET(BSP_SRC stm32f0308_discovery)
	ENDIF()
	set(COMMON_COMPONENTS 
		hx8347d
		l3gd20
...
IF(NOT STM32BSP_FIND_COMPONENTS)
	SET(STM32BSP_FIND_COMPONENTS ${BSP_COMPONENTS})
...
FOREACH(cmp ${STM32BSP_FIND_COMPONENTS})
	...
	IF(${STM32BSP_FOUND_INDEX} LESS 0)
		...
		ELSE()
			LIST(APPEND BSP_COMMON_HEADERS ${cmp})
			LIST(APPEND BSP_SRC ${cmp})
		ENDIF()
	ELSE()
		LIST(APPEND BSP_HEADERS ${BSP_PREFIX}${cmp}.h)
		LIST(APPEND BSP_SRC ${BSP_PREFIX}${cmp})
	ENDIF()
ENDFOREACH()
