...
IF(NOT FreeRTOS_DIR)
	MESSAGE(STATUS "No FreeRTOS_DIR specified, using FreeRTOS include in STM32Cube")
	IF(NOT STM32Cube_DIR)
		SET(STM32Cube_DIR "/opt/STM32Cube_FW_F1_V1.2.0")
		MESSAGE(STATUS "No STM32Cube_DIR specified, using default: " ${STM32Cube_DIR})
	ENDIF()
	SET(FreeRTOS_DIR ${STM32Cube_DIR}/Middlewares/Third_Party)
ENDIF()
...
FIND_PATH(FREERTOS_COMMON_INCLUDE_DIR ${FREERTOS_COMMON_HEADERS}
	HINTS ${FreeRTOS_DIR}/FreeRTOS/Source/include
    CMAKE_FIND_ROOT_PATH_BOTH
)

#FIND_PATH(FREERTOS_COMMON_INCLUDE_DIR2 cmsis_os.h
#	HINTS ${FreeRTOS_DIR}/FreeRTOS/Source/CMSIS_RTOS
#    CMAKE_FIND_ROOT_PATH_BOTH
#)

FIND_PATH(FREERTOS_DEVICE_INCLUDE_DIR portmacro.h
	HINTS ${FreeRTOS_DIR}/FreeRTOS/Source/portable/GCC/${FREERTOS_DEVICE_SOURCES}
    CMAKE_FIND_ROOT_PATH_BOTH
)
...
FIND_FILE(FREERTOS_HEAP ${FREERTOS_HEAP_SOURCE}
	HINTS ${FreeRTOS_DIR}/FreeRTOS/Source/portable/MemMang/
	CMAKE_FIND_ROOT_PATH_BOTH
)
...
FOREACH(SRC ${FREERTOS_COMMON_SOURCES})
	...
	FIND_FILE(SRC_FILE ${SRC}
		HINTS ${FreeRTOS_DIR}/FreeRTOS/Source/
        CMAKE_FIND_ROOT_PATH_BOTH
    )
