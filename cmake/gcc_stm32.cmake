...
FUNCTION(STM32_ADD_FLASH_DEBUG_TARGETS TARGET)
	IF(EXECUTABLE_OUTPUT_PATH)
		SET(FILENAME "${EXECUTABLE_OUTPUT_PATH}/${TARGET}")
	ELSE()
		SET(FILENAME "${TARGET}")
	...
	IF(NOT OPENOCD_CONFIG)
		MESSAGE(STATUS "No OPENOCD_CONFIG specified, trying to get it from STM_BOARD.")
		STRING(REGEX REPLACE "^.+-([A-Za-z]+)$" "\\1" STM32_BOARD_TYPE ${STM_BOARD})
		STRING(TOLOWER ${STM32_BOARD_TYPE} STM32_BOARD_TYPE_LOWER)
